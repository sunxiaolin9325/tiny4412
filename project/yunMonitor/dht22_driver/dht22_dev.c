...
static __init int dht22_dev_init(void)
{
	return platform_device_register(&dht22_dev);
}

static __exit void dht22_dev_exit(void)
{
	platform_device_unregister(&dht22_dev);
}

module_init(dht22_dev_init);
module_exit(dht22_dev_exit);
